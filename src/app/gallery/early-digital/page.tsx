...
const galleryImages = [
  {
    id: 1,
    src: '/DigitalPinoy/images/gallery/early-digital/friendster-1.jpg',
    title: 'Friendster Profile',
    description: 'Classic Friendster profile with glitter graphics and testimonials',
    year: '2003',
    category: 'Social Media'
  },
  {
    id: 2,
    src: '/DigitalPinoy/images/gallery/early-digital/nokia-1.jpg',
    title: 'Nokia 3310',
    description: 'The legendary indestructible phone everyone had',
    year: '2002',
    category: 'Technology'
  },
  {
    id: 3,
    src: '/DigitalPinoy/images/gallery/early-digital/internet-cafe-1.jpg',
    title: 'Internet Café',
    description: 'Computer shop gaming sessions and Ragnarok Online',
    year: '2004',
    category: 'Gaming'
  },
  {
    id: 4,
    src: '/DigitalPinoy/images/gallery/early-digital/text-1.jpg',
    title: 'Text Messaging',
    description: 'Text mo ko culture and unlimited texting promos',
    year: '2003',
    category: 'Communication'
  },
  {
    id: 5,
    src: '/DigitalPinoy/images/gallery/early-digital/cd-1.jpg',
    title: 'CD-R Collection',
    description: 'Burned CDs with marker labels from Quiapo',
    year: '2004',
    category: 'Entertainment'
  },
  {
    id: 6,
    src: '/DigitalPinoy/images/gallery/early-digital/webcam-1.jpg',
    title: 'Webcam Photos',
    description: 'Pixelated webcam selfies before selfies were cool',
    year: '2005',
...
export default function EarlyDigitalGallery() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-950 via-emerald-950 to-gray-950 relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-96 h-96 bg-green-500 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-emerald-500 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-black/80 via-black/70 to-black/80 backdrop-blur-xl py-6 border-b border-green-500/30 relative z-10 sticky top-0"
      >
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <Link href="/gallery" className="inline-flex items-center gap-2 text-green-400 hover:text-green-300 transition-all hover:gap-3 group">
              ...
              <div className="hidden md:block">
                <h1 className="text-2xl font-bold bg-gradient-to-r from-green-300 to-emerald-300 bg-clip-text text-transparent">
                  Early Digital Era
                </h1>
                <p className="text-gray-400 text-sm">2000-2005 • {filteredImages.length} Photos</p>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <span className="bg-green-500/20 border border-green-400/30 px-4 py-2 rounded-full text-green-300 text-sm font-medium backdrop-blur-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {filteredImages.map((image, index) => (
                ...
                >
                  <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/20 hover:border-green-400/50 transition-all shadow-lg hover:shadow-2xl">
                    {/* Image Placeholder */}
                    <div className="aspect-[4/3] bg-gradient-to-br from-green-500/20 to-emerald-500/20 flex items-center justify-center relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 to-emerald-500/10 group-hover:scale-110 transition-transform duration-700" />
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="bg-green-500/50 backdrop-blur-sm px-3 py-1 rounded-full text-white text-xs font-semibold">
                          {image.year}
                        </span>
                    ...
                    {/* Category Badge */}
                    <div className="absolute top-3 left-3 bg-green-500/70 backdrop-blur-sm px-3 py-1 rounded-full">
        ...
        <motion.div
          ...
          className="mt-16 bg-gradient-to-br from-black/70 to-black/60 backdrop-blur-xl rounded-3xl p-8 border border-green-500/30"
        >
          <h2 className="text-3xl font-bold text-white mb-4">About the Early Digital Era (2000-2005)</h2>
          <p className="text-gray-300 leading-relaxed mb-6">
            This was the dawn of Filipino digital culture. When Friendster was king, Nokia phones were indestructible,
            and internet cafés were packed with Ragnarok Online players. Text messaging became an art form, and CD-Rs
            from Quiapo were the primary source of entertainment.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-green-500/10 p-4 rounded-xl border border-green-500/30">
              <h3 className="text-green-300 font-semibold mb-2">Popular Platforms</h3>
            ...
            <div className="bg-emerald-500/10 p-4 rounded-xl border border-emerald-500/30">
              <h3 className="text-emerald-300 font-semibold mb-2">Cultural Moments</h3>
              <ul className="text-gray-300 text-sm space-y-1">
                <li>• Glitter graphics</li>
                <li>• Testimonials trading</li>
                <li>• Text brigade</li>
                <li>• Computer shop culture</li>
              </ul>
            </div>
            <div className="bg-teal-500/10 p-4 rounded-xl border border-teal-500/30">
              <h3 className="text-teal-300 font-semibold mb-2">Tech Highlights</h3>
              <ul className="text-gray-300 text-sm space-y-1">
                <li>• Nokia 3310/3315</li>
                <li>• Dial-up internet</li>
                <li>• CD-R burning</li>
                <li>• Monophonic ringtones</li>
              </ul>
            </div>
          </div>
        </motion.div>
        ...
        {selectedImage && (
          ...
          >
            ...
            <div className="relative z-20 flex items-center justify-between px-4 md:px-6 py-3 bg-gradient-to-b from-black/80 to-transparent">
              {/* Counter - Minimal */}
              <div className="flex items-center gap-3">
                <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-xl px-4 py-2 rounded-xl border border-green-500/30">
              ...
              <div className="flex items-center gap-2">
                ...
                <motion.button
                  ...
                  className="w-9 h-9 rounded-xl bg-gradient-to-br from-white/10 to-white/5 hover:from-white/20 hover:to-white/10 flex items-center justify-center transition-all border border-white/10 hover:border-green-500/50 group"
                >
                  <Download className="w-4 h-4 text-white group-hover:text-green-400 transition-colors" />
                </motion.button>
            ...
            <div className="flex-1 flex items-center justify-center px-2 relative min-h-0">
              ...
              <motion.button
                ...
                className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-lg bg-gradient-to-br from-green-500/90 to-emerald-500/90 hover:from-green-400 hover:to-emerald-400 backdrop-blur-xl flex items-center justify-center transition-all z-20 border border-white/20 shadow-xl group"
              >
              ...
              <motion.button
                ...
                className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-lg bg-gradient-to-br from-green-500/90 to-emerald-500/90 hover:from-green-400 hover:to-emerald-400 backdrop-blur-xl flex items-center justify-center transition-all z-20 border border-white/20 shadow-xl group"
              >
              ...
              >
                <div className="relative w-full h-full bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-2xl rounded-xl overflow-hidden border border-green-500/30 shadow-2xl">
                  {/* Image Container with Overlay */}
                  <div className="relative w-full h-full bg-gradient-to-br from-green-500/10 to-emerald-500/10 flex items-center justify-center overflow-hidden">
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          <h2 className="text-xl md:text-2xl font-bold text-white mb-1 bg-gradient-to-r from-green-300 to-emerald-300 bg-clip-text text-transparent truncate">
                            {selectedImage.title}
                          </h2>
                        ...
                        <div className="flex gap-2 flex-shrink-0">
                          <motion.div
                            ...
                            className="bg-gradient-to-br from-green-500 to-emerald-600 px-3 py-1 rounded-lg shadow-lg"
                          >
                          ...
                          <motion.div
                            ...
                            className="bg-gradient-to-br from-emerald-500 to-teal-600 px-3 py-1 rounded-lg shadow-lg hidden md:block"
                          >
                  ...
                  {filteredImages.map((img, idx) => (
                    <motion.button
                      ...
                      className={`relative flex-shrink-0 rounded-lg overflow-hidden transition-all border-2 ${
                        idx === selectedImageIndex
                          ? 'border-green-400 shadow-lg shadow-green-500/50 w-16 h-16 md:w-18 md:h-18'
                    ...
                    >
                      ...
                      {idx === selectedImageIndex && (
                        <div className="absolute bottom-0.5 right-0.5 bg-green-500 px-1.5 py-0.5 rounded backdrop-blur-sm">
