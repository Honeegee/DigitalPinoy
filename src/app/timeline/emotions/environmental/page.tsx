...
export default function EmotionsEnvironmentalPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-black">
      ...
      <div className="fixed top-20 left-6 z-40">
        <Link href="/timeline/emotions" className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/20 backdrop-blur-md border border-teal-500/30 text-teal-300 hover:bg-teal-500/30 transition-all">
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-teal-900 to-emerald-900 flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <div className="text-white text-xl font-bold mb-2">Low Awareness (2000-2010)</div>
                      <div className="text-teal-300 text-sm">INSERT: Video/GIF of early 2000s environmental disconnect</div>
                    </div>
                  </div>
                ...
                >
                  {[
                    { icon: '❓', value: 'Low', label: 'Eco-awareness' },
                    { icon: '👨‍👩‍👧', value: 'Human', label: 'Focus Only' },
                    { icon: '🌍', value: 'Disconnected', label: 'from Nature' }
                  ].map((stat, i) => (
                    <motion.div
                      key={i}
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-2xl text-gray-300 mb-6 leading-relaxed">
                    Environmental emotions were <span className="text-teal-400 font-bold">barely acknowledged</span> in digital culture.
                  </p>

                  <div className="space-y-4">
                    {[
                      { icon: <Heart className="w-6 h-6" />, title: 'Low Eco-awareness', desc: 'Limited emotional connection to environmental issues online' },
                      { icon: <Users className="w-6 h-6" />, title: 'Human Focus Only', desc: 'Digital conversations centered on human experiences, not nature' },
                      { icon: <Sparkles className="w-6 h-6" />, title: 'Disconnected from Nature', desc: 'Growing digital presence meant decreasing nature connection' }
                    ].map((item, i) => (
                      <motion.div
                        key={i}
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-2xl text-gray-300 mb-6 leading-relaxed">
                    Environmental emotions became <span className="text-cyan-400 font-bold">intense and widespread</span> through digital awareness.
                  </p>

                  <div className="space-y-4">
                    {[
                      { icon: '😰', title: 'Eco-grief', desc: 'Climate anxiety and eco-grief shared widely on social media' },
                      { icon: '💚', title: 'Green Communities', desc: 'Facebook groups and Discord servers for environmental action' },
                      { icon: '📢', title: 'Digital Activism', desc: 'Viral campaigns mobilize emotional responses to climate issues' }
                    ].map((item, i) => (
                      <motion.div
                        key={i}
                        initial={{ opacity: 0, x: -20 }}
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-cyan-900 to-teal-900 flex items-center justify-center">
                    <div className="text-center p-8">
                      <div className="text-8xl mb-4">😰</div>
                      <div className="text-white text-xl font-bold mb-2">Climate Anxiety (2024)</div>
                      <div className="text-cyan-300 text-sm">INSERT: Climate activism & eco-grief GIF</div>
                    </div>
                  </div>
                ...
                >
                  {[
                    { icon: '😰', value: 'Rising', label: 'Eco-anxiety' },
                    { icon: '💚', value: 'Growing', label: 'Green Groups' },
                    { icon: '📢', value: 'Viral', label: 'Activism' }
                  ].map((stat, i) => (
                    <motion.div
                      key={i}
                      whileHover={{ scale: 1.1, y: -5 }}
        ...
        <section className="min-h-screen flex items-center justify-center py-20">
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              ...
              <h2 className="text-6xl font-black mb-8 bg-gradient-to-r from-purple-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent">
                Eco-Emotional AI
              </h2>

              <p className="text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
                Technology will <span className="text-purple-400 font-bold">heal environmental emotions</span> and reconnect us to nature.
              </p>

              {/* Future vision grid */}
              <div className="grid md:grid-cols-3 gap-6 mb-12">
                {[
                  { emoji: '🤖', title: 'Eco-emotional AI', desc: 'AI therapists specialized in climate anxiety and eco-grief support', color: 'from-purple-500 to-teal-500' },
                  { emoji: '🌳', title: 'Virtual Nature Therapy', desc: 'Immersive nature experiences for emotional healing and connection', color: 'from-teal-500 to-cyan-500' },
                  { emoji: '♻️', title: 'Sustainable Emotional Tech', desc: 'Carbon-neutral platforms promoting positive environmental emotions', color: 'from-cyan-500 to-purple-500' }
                ].map((item, i) => (
                  <motion.div
                    key={i}
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-purple-900 via-teal-900 to-cyan-900 flex items-center justify-center">
                  <div className="text-center p-12">
                    ...
                    <div className="text-white text-2xl font-bold mb-3">Eco-emotional AI (2030)</div>
                    <div className="text-purple-300">INSERT: Nature therapy & AI healing concept video/GIF</div>
                  </div>
                </div>
        ...
        <section className="min-h-screen flex items-center justify-center py-20">
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              <h2 className="text-5xl font-black mb-6 bg-gradient-to-r from-teal-400 to-purple-400 bg-clip-text text-transparent">
                The Environmental Journey
              </h2>
              <p className="text-2xl text-gray-400">
                From unawareness to anxiety—tech can heal our environmental emotions
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-xl border border-teal-500/30 rounded-3xl p-10">
                  ...
                  <p className="text-xl text-gray-300 font-semibold mb-4">
                    Unaware → Anxious → Healing through tech
                  </p>
                  <p className="text-gray-400 leading-relaxed">
                    We moved from disconnection with nature and low eco-awareness to widespread climate anxiety and eco-grief, heading toward AI-powered healing and virtual nature therapy.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-xl border border-purple-500/30 rounded-3xl p-10">
                  ...
                  <p className="text-xl text-gray-300 font-semibold mb-4">
                    Emotion-driven environmental action; Tech for eco-healing
                  </p>
                  <p className="text-gray-400 leading-relaxed">
                    The future promises AI therapists for climate anxiety, virtual nature experiences that heal eco-grief, and sustainable technology platforms that foster positive environmental emotions.
                  </p>
                </div>
              </motion.div>
            </div>
