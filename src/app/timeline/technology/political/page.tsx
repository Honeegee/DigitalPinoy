...
export default function TechnologyPoliticalPage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-black">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-b from-purple-950/40 via-black to-pink-950/40"></div>
        <motion.div
      ...
      <div className="fixed top-20 left-6 z-40">
        <Link href="/timeline/technology" className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/20 backdrop-blur-md border border-purple-500/30 text-purple-300 hover:bg-purple-500/30 transition-all">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            From SMS Activism to Digital Democracy
          </motion.p>
      ...
      <div className="relative z-10">
        ...
        {/* 2000-2010: EDSA II Text Activism */}
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-2xl text-gray-300 mb-6 leading-relaxed">
                    January 2001 marked a turning point when Filipinos used <span className="text-purple-400 font-bold">SMS to coordinate protests</span> that ousted a president.
                  </p>

                  <div className="space-y-4 text-gray-300 leading-relaxed">
                    <p>
                      "Go 2EDSA. Wear blk" became the rallying cry that changed history. Text brigades organized protests,
                      shared updates, and mobilized millions without traditional media.
                    </p>
                    <p className="text-purple-300 font-semibold">
                      The Philippines became the first nation to overthrow a leader through digital coordination.
                    </p>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="relative">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-900 to-pink-900 flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <div className="text-white text-xl font-bold mb-2">EDSA II (2001)</div>
                      <div className="text-purple-300 text-sm">INSERT: Video/GIF of EDSA II crowds</div>
                    </div>
                  </div>
                ...
                >
                  {[
                    { icon: '📱', value: '7M', label: 'Text Messages' },
                    { icon: '⏰', value: '4 Days', label: 'To Mobilize' }
                  ].map((stat, i) => (
                    <motion.div
                      key={i}
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <p className="text-2xl text-gray-300 mb-6 leading-relaxed">
                  Political discourse shifted entirely to <span className="text-cyan-400 font-bold">social media platforms</span>.
                </p>

                <div className="space-y-4">
                  {[
                    { icon: '📱', title: 'Platform Politics', desc: 'Facebook, Twitter, and TikTok became battlegrounds for narratives' },
                    { icon: '🌐', title: 'Viral Movements', desc: 'Hashtags and trending topics shape public opinion instantly' },
                    { icon: '⚠️', title: 'Digital Challenges', desc: 'Misinformation spreads faster, echo chambers polarize communities' }
                  ].map((item, i) => (
                    <motion.div
                      key={i}
            ...
            <div className="relative">
              ...
              >
                {/* Placeholder for social media interface */}
                <div className="absolute inset-0 bg-gradient-to-br from-cyan-900 to-purple-900 flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="text-8xl mb-4">📱</div>
                    <div className="text-white text-xl font-bold mb-2">Social Media Politics (2024)</div>
                    <div className="text-cyan-300 text-sm">INSERT: Video/GIF of viral political hashtags</div>
                  </div>
                </div>

                {/* Hashtag icons floating */}
                {['📣', '⚠️', '📊', '🌐', '💬'].map((emoji, i) => (
                  <motion.div
                    key={i}
                    animate={{
              ...
              >
                {[
                  { icon: '📱', value: '85%', label: 'Get News Online' },
                  { icon: '🌐', value: '#1', label: 'Social Media Use' },
                  { icon: '⚡', value: 'Instant', label: 'Viral Spread' }
                ].map((stat, i) => (
                  <motion.div
                    key={i}
                    whileHover={{ scale: 1.1, y: -5 }}
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-6xl font-black mb-8 bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent">
              AI-Moderated Democracy
            </h2>

            <p className="text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Blockchain voting, <span className="text-purple-400 font-bold">AI fact-checkers</span>, and digital governance transform democracy.
            </p>

            {/* Future vision grid */}
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {[
                { emoji: '🗳️', title: 'Blockchain Voting', desc: 'Transparent, tamper-proof elections verified by all', color: 'from-purple-500 to-pink-500' },
                { emoji: '🤖', title: 'AI Moderators', desc: 'Real-time fact-checking and bot detection', color: 'from-pink-500 to-cyan-500' },
                { emoji: '🌐', title: 'Digital Rights', desc: 'Constitutional protections for online citizens', color: 'from-cyan-500 to-purple-500' }
              ].map((item, i) => (
                <motion.div
                  key={i}
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-purple-900 via-pink-900 to-cyan-900 flex items-center justify-center">
                <div className="text-center p-12">
                  ...
                  <div className="text-white text-2xl font-bold mb-3">Digital Democracy (2030)</div>
                  <div className="text-purple-300">INSERT: Blockchain voting concept video/GIF</div>
                </div>
              </div>
      ...
      <section className="min-h-screen flex items-center justify-center py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <h2 className="text-5xl font-black mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              The Journey Continues
            </h2>
            <p className="text-2xl text-gray-400">
              From SMS activism to AI-moderated democracy—technology transforms how we participate in governance
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative bg-gray-900/80 backdrop-blur-xl border border-purple-500/30 rounded-3xl p-10">
                ...
                <p className="text-xl text-gray-300 font-semibold mb-4">
                  SMS activism → Platform politics → AI-regulated democracy
                </p>
                <p className="text-gray-400 leading-relaxed">
                  We moved from coordinated text messages to social media campaigns, and now toward technology-verified governance. Each step increases transparency while raising new challenges about truth and control.
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative group"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-pink-500 to-cyan-500 opacity-20 blur-2xl group-hover:opacity-30 transition-opacity" />
              <div className="relative bg-gray-900/80 backdrop-blur-xl border border-pink-500/30 rounded-3xl p-10">
                ...
                <p className="text-xl text-gray-300 font-semibold mb-4">
                  Digital governance, blockchain voting, AI fact-checking
                </p>
                <p className="text-gray-400 leading-relaxed">
                  The future promises transparent, tamper-proof elections and real-time verification of information. Technology will either strengthen democratic participation or create new forms of digital control—we choose which path.
                </p>
              </div>
            </motion.div>
          </div>
